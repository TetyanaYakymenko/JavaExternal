    ...
    <jsp:include  page="header.jsp"/>
                ...
                <tr>
                    ...
                    <td>
                        <form method="POST" action="main">
                            ...
                            <button type="submit" class="btn btn-primary"><fmt:message key="reports_edit"/></button>
                        </form>
                    </td>
                    </c:if>
                </tr>
        ...
        <form  class="px-1 py-3 mx-auto"  method = "POST" action = "">
            <div>
                ...
                <button type="submit" class="btn btn-primary"><fmt:message key="reports_past"/></button>
            </div>
        </form>
        <form  class="px-1 py-3 mx-auto"  method = "POST" action = "main">
            <div>
                ...
                <button type="submit" class="btn btn-primary"><fmt:message key="reports_upcoming"/></button>
            </div>
        </form>
        <form  class="px-1 py-3 mx-auto"  method = "POST" action = "main">
            <div>
                <input type = "hidden" name = "command"  value = "reports" />
                <button type="submit" class="btn btn-primary"><fmt:message key="reports_all_reports"/></button>
            </div>
        </form>
        </div>
        </form>
