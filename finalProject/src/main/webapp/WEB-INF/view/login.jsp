    ...
    <fmt:setBundle basename="localization"/>
                ...
                <ul class="nav nav-pills card-header-pills text-primary">
                    ...
                    <li class="nav-item" >
                        <form name = "Logout"  method = "POST" action = "language" >
                            ...
                            <button type="submit" class="btn btn-primary"><fmt:message key="login_RU"/></button>
                        </form>
                    </li>
                    <li class="nav-item" >
                        <form name = "Logout"  method = "POST" action = "language" >
                            ...
                            <button type="submit" class="btn btn-primary"><fmt:message key="login_ENG"/></button>
                        </form>
                    </li>
                </ul>
            </div>
        <form name = "LoginForm" class="px-4 py-3 mx-auto"  method = "POST" action = "main"  >
            ...
            <div class="form-group mx-auto ">
                <label for="login" style="width: 100px;"><fmt:message key="login_login_label"/>:</label>
                <input type = "text" style="width: 300px;" placeholder="login" id="login" name = "login" value ="" />
                <br/>
            </div>
            <div class="form-group mx-auto">
                <label for="login" style="width: 100px;"><fmt:message key="login_pass_label"/>:</label>
           ...
           ${nullPage}
            ...
            <button type="submit" class="btn btn-primary"><fmt:message key="login_login"/></button>
            </div>
        </form>
        <form  class="px-4 py-3 mx-auto"  method = "POST" action = "main">
            <div>
                <input type = "hidden" name = "command"  value = "register" />
                <button type="submit" class="btn btn-primary"><fmt:message key="login_register"/></button>
            </div>
        </form>
