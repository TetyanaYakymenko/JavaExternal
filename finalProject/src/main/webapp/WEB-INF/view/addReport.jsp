    ...
    <fmt:setLocale value="${locale}"/>
        ...
        <form name = "EditForm" class="px-4 py-3 mx-auto"  method = "POST" action = "edit"  >
            ...
            <div class="form-group mx-auto ">
                ...
                <input type = "text" style="width: 300px;" placeholder="${reportDisplay.getReportName()}" id="name"  name = "name" value ="${reportDisplay.getReportName()}" />
                <br/>
            </div>
            ...
            <div class="form-group mx-auto ">
                ...
                <input type = "text" style="width: 300px;"  id="conference"  name = "login" value ="${reportDisplay.getConferenceName()}" />
                <br/>
            </div>
            <div class="form-group mx-auto">
